...
class PC_FAQ_Asset_Manager
{
    ...
    {
        // 🛡️ Condition large : Logements, Expériences, Destinations, Pages standards et Articles
        ...
        if (file_exists($css_path)) {
            wp_enqueue_style('pc-faq-style', PC_FAQ_URL . 'assets/css/pc-faq.css', [], filemtime($css_path));
        }
        ...
        if (file_exists($js_path)) {
            wp_enqueue_script('pc-faq-script', PC_FAQ_URL . 'assets/js/pc-faq.js', [], filemtime($js_path), true);
        }
    }
}
